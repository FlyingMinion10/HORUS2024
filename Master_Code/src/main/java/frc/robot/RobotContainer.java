...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_autoChooser.setDefaultOption("Autónomo Central Izquierdo", new AutonomousCentre_L_Command(swerveSubsystem, launcherSubsystem));
    m_autoChooser.addOption("Autónomo Central Derecho", new AutonomousCentre_R_Command(swerveSubsystem, launcherSubsystem));
    m_autoChooser.addOption("Autónomo Izquierdo Largo", new AutonomousLeft_F_Command(swerveSubsystem, launcherSubsystem));
    m_autoChooser.addOption("Autónomo Izquierdo Corto", new AutonomousLeft_C_Command(swerveSubsystem, launcherSubsystem));
  ...
  private void configureBindings() {
    ...
    new JoystickButton(shooterController, 1) // Launcher con velocidad 75 (A)
            .whileTrue(new LauncherActivateCmd(launcherSubsystem, swerveSubsystem, LauncherConstants.kUpperRoller_Speed1));
    new JoystickButton(shooterController, 4) // Launcher con velocidad 85 (Y)
            .whileTrue(new LauncherActivateCmd(launcherSubsystem, swerveSubsystem, LauncherConstants.kUpperRoller_Speed2));
