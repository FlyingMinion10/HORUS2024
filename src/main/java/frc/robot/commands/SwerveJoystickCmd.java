...
public class SwerveJoystickCmd extends Command {
    ...
    private final Supplier<Boolean> autoAimFunction;
    ...
    public void execute() {
        ...
        if ( autoAimFunction.get() ) {
            ...
            .fromFieldRelativeSpeeds(xSpeed, ySpeed, limeLightSubsystem.getAlignmentSpeed(), swerveSubsystem.getRotation2d()));
        } else {
            moduleStates = DriveConstants.kDriveKinematics.toSwerveModuleStates(chassisSpeeds); }
