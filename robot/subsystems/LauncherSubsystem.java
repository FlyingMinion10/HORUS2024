...
public class LauncherSubsystem extends SubsystemBase {
    ...
    public void periodic() { // FUncion periodica para publicar Dashboards
        SmartDashboard.putNumber("Upper Right Roller", upperRight_Encoder.getPosition());
        SmartDashboard.putNumber("Upper Left Roller", upperLeft_Encoder.getPosition());
        SmartDashboard.putNumber("Lower Right Roller", lowerRight_Encoder.getPosition());
        SmartDashboard.putNumber("Lower Left Roller", lowerLeft_Encoder.getPosition());
    }
