...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_autoChooser.setDefaultOption("Autonomo deshabilitado", null);
    m_autoChooser.addOption("Autónomo Central Izquierdo", new AutonomousCentre_L_Command(swerveSubsystem, launcherSubsystem));
  ...
  private void configureBindings() {
    ...
    new JoystickButton(driverJoystick, 3) // Auto alinearse al speaker (X)
            .toggleOnTrue(new AutoAimCmd(swerveSubsystem, limeLightSubsystem));
