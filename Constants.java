...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        public static final double kBackLeftDriveAbsoluteEncoderOffsetRad = 0.4685;
        public static final double kFrontRightDriveAbsoluteEncoderOffsetRad = -0.1225;
        public static final double kBackRightDriveAbsoluteEncoderOffsetRad = 0.1484;
        public static final double kFrontLeftDriveAbsoluteEncoderOffsetRad = 0.0040;

        public static final double kPhysicalMaxSpeedMetersPerSecond = 5;
        public static final double kPhysicalMaxAngularSpeedRadiansPerSecond = 2 * 2 * Math.PI;

        public static final double kTeleDriveMaxSpeedMetersPerSecond = kPhysicalMaxSpeedMetersPerSecond / 1.2; // Velocidad lineal maxima
    ...
    public static final class LauncherConstants {
        ...
        public static final double kUpperRoller_Speed1 = 0.7;
        public static final double kUpperRoller_Speed2 = 0.9;
