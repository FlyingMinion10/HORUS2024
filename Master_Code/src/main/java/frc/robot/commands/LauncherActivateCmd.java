...
public class LauncherActivateCmd extends Command {
    ...
    public LauncherActivateCmd(LauncherSubsystem launcherSubsystem_i, SwerveSubsystem swerveSubsystem_i, IntakeSubsystem intakeSubsystem_i, double speed) {
    ...
    public void execute() {
        ...
        switch (stage) {
            case 0:
                launcherSubsystem.all_Rollers(speed);// Revolucionar los rollers de arriba
