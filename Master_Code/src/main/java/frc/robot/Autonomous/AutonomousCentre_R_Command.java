...
public class AutonomousCentre_R_Command extends SequentialCommandGroup {


    public AutonomousCentre_R_Command(SwerveSubsystem swerveSubsystem, LauncherSubsystem launcherSubsystem) {
