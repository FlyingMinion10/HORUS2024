...
public class AutonomousLeft_C_Command extends SequentialCommandGroup {


    public AutonomousLeft_C_Command(SwerveSubsystem swerveSubsystem, LauncherSubsystem launcherSubsystem) {
        ...
        Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
            ...
            new Pose2d(2, -0.15, Rotation2d.fromDegrees(90)),
            trajectoryConfig);
