...
public class AutonomousLeft_F_Command extends SequentialCommandGroup {


    public AutonomousLeft_F_Command(SwerveSubsystem swerveSubsystem, LauncherSubsystem launcherSubsystem) {
        ...
        Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
            ...
            new Pose2d(3.0, 2.5, Rotation2d.fromDegrees(90)),
            trajectoryConfig);
