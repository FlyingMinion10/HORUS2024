...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
        //PathPlannerPath path = PathPlannerPath.fromPathFile("(Centre) 1st reload)");
        //return AutoBuilder.followPath(path);
        return p_autoChooser.getSelected();
//return new SequentialCommandGroup( AutoBuilder.followPath(PathPlannerPath.fromPathFile("(Centre) 1st reload)")),
//AutoBuilder.followPath(PathPlannerPath.fromPathFile("(Centre) 1st score)")));
